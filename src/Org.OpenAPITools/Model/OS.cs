...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class OS : IEquatable<OS>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "patchMinor", EmitDefaultValue = true)]
        public string PatchMinor { get; private set; }

        /// <summary>
        /// Returns false as PatchMinor should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializePatchMinor()
        {
            return false;
        }

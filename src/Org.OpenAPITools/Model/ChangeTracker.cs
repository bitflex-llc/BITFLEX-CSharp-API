...
namespace Org.OpenAPITools.Model
{
    ...
    /// ChangeTracker
    /// </summary>
    [DataContract(Name = "ChangeTracker")]
    public partial class ChangeTracker : IEquatable<ChangeTracker>, IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets DebugView
        /// </summary>
        [DataMember(Name = "debugView", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DebugView: ").Append(DebugView).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(ChangeTracker input)
        {
            ...
            return 
                ...
                (
                    this.DebugView == input.DebugView ||
                    (this.DebugView != null &&
                    this.DebugView.Equals(input.DebugView))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DebugView != null)
                    hashCode = hashCode * 59 + this.DebugView.GetHashCode();
                return hashCode;
            }
        }
